            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table text-center align-items-center mb-0"> 
                  ...
                  <tbody>
                    <tr>
                      <td class="align-middle text-center text-sm">Alya Rahma</td>
                      <td class="align-middle text-center text-sm">210301</td>
                      <td class="align-middle text-center text-sm">X IPA 2</td>
                      <td class="align-middle text-center text-sm">2025-03-05</td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-warning">Menunggu Konfirmasi</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="bukti_pembayaran/alya.jpg" target="_blank" class="text-primary text-decoration-none">Lihat Bukti</a>
                      </td>
                    ...
                    <tr>
                      <td class="align-middle text-center text-sm">Bagas Putra</td>
                      <td class="align-middle text-center text-sm">210312</td>
                      <td class="align-middle text-center text-sm">XI IPS 1</td>
                      <td class="align-middle text-center text-sm">2025-03-10</td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Selesai</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="bukti_pembayaran/bagas.png" target="_blank" class="text-primary text-decoration-none">Lihat Bukti</a>
                      </td>
                      <td class="align-middle">
                    ...
                    <tr>
                      <td class="align-middle text-center text-sm">Citra Maharani</td>
                      <td class="align-middle text-center text-sm">210327</td>
                      <td class="align-middle text-center text-sm">XII IPA 3</td>
                      <td class="align-middle text-center text-sm">2025-03-15</td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-warning">Menunggu Konfirmasi</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <a href="bukti_pembayaran/citra.jpg" target="_blank" class="text-primary text-decoration-none">Lihat Bukti</a>
                      </td>
                      <td class="align-middle">
                        <button type="button" class="btn btn-danger btn-icon btn-sm p-1" style="width: 30px; height: 30px;" title="Edit Kelas">
                          <a href="javascript:;" class="text-white font-weight-bold text-xs">
